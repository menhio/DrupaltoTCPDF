...
<table>
  <tr bgcolor="#dddddd">
    <th class="pull-center" width="22%">NOMBRE</th>
    <th class="pull-center" width="8%">B/M</th>
    <th class="pull-center" width="10%">PUESTO</th>
    <th class="pull-center" width="10%">ÚLTIMO</th>
    <th class="pull-center" width="8%">ESTADO</th>
    <th class="pull-center" width="10%">VENCIMIENTO</th>
    <th class="pull-center" width="32%">STATUS</th>
  </tr>';
/*
 * Tripulantes Query
*/
...
foreach ($results2 as $result2) {
  ...
  $html .= '<td class="pull-left">' . ucfirst(strtolower($status)) . '</td>';
  $html .= '</tr>';
